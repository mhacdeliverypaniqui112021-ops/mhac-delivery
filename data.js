...
window.MHAC={
 stores:{
  "Jollibee":{
   categories:{
    "Chickenjoy":[
     {id:"jb-c1",name:"1-pc. Chickenjoy w/ Drink",price:99,img:"assets/chickenjoy.jpg",addons:[
      {name:"Coke Regular",price:0},{name:"Coke Zero Regular",price:0},{name:"Go Coke Float",price:45}]},
     {id:"jb-c2",name:"2-pc. Chickenjoy w/ Drink",price:165,img:"assets/chickenjoy.jpg",addons:[
      {name:"Coke Regular",price:0},{name:"Coke Zero Regular",price:0},{name:"Go Coke Float",price:45}]},
    ...
    "Burgers":[
     {id:"jb-b1",name:"Yumburger",price:45,img:"assets/burger.jpg"},
     {id:"jb-b2",name:"Cheesy Yumburger",price:75,img:"assets/burger.jpg"}],
    "Jolly Spaghetti":[
    ...
    "Super Meals":[
     {id:"jb-m1",name:"1-pc Chickenjoy Super Meal",price:149,img:"assets/chickenjoy.jpg"}],
    "Sides":[
     {id:"jb-side1",name:"Regular Fries",price:55,img:"assets/fries.jpg"}],
    "Drinks":[
     {id:"jb-d1",name:"Coke Regular",price:45,img:"assets/drink.jpg"},
     {id:"jb-d2",name:"Coke Zero",price:45,img:"assets/drink.jpg"}]
   }},
 ...
 rate:{base:40,perKm:10,secondStore:5,service:0.10},
